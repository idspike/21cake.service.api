...
return array(
    ...
    'name' => '获取多个配送单信息',
    'intro' => '通过配送员工号和配送单状态查询配送单信息',
    'brief' => '通过配送员工号查询该员工下的配送单信息（可以传入配送单的不同状态）',
    'request_data' => array(// 请求值
                                ...
                                array(
                                    ...
                                    'example_val' => '1',
                                    'default_val' => '无',
                                    'desc' => '配送单状态(可选值：pause:暂停;packaging:已打包;out:已出库;in:已进站;progress:运送中;succ:成功到达;cancel:已取消;）',
                                ),
    ),
